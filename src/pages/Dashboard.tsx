...
export default function Dashboard() {
  ...
  const [activeView, setActiveView] = useState<'orders' | 'tools'>('orders');
            ...
            <div className="space-y-8 animate-in fade-in duration-500">
              {activeView === 'orders' ? (
                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between">
                    <div>
                      <h1 className="text-4xl font-black text-gray-900 tracking-tight">Farmer Utilities</h1>
                      <p className="text-gray-500 font-medium mt-1">Smart tools to optimize your dragon fruit plantation.</p>
                    </div>
                  </div>
                  <NutrientCalculator />
                </div>
...
function ProfileBtn({ icon, label, active, onClick }: any) {
  return (
    <button 
      onClick={onClick}
